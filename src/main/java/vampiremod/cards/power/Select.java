...
import vampiremod.powers.SelectPower;
import vampiremod.util.CardInfo;

import static vampiremod.vampiremod.makeID;

public class Select extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Select", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new SelectPower(p, magicNumber), magicNumber));
    }
