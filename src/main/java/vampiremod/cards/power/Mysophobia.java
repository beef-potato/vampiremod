...
public class Mysophobia extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Mysophobia", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new MysophobiaPower(p, magicNumber), magicNumber));

    }

    @Override
    public AbstractCard makeCopy() {
        return new Mysophobia();
    }
