...
public class Simplelife extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Simplelife", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new RegenPower(p, magicNumber), STACK_AMOUNT));
    }

    @Override
    public AbstractCard makeCopy() { return new Simplelife();
    }
