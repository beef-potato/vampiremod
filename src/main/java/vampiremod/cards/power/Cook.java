...
import vampiremod.powers.CookPower;
import vampiremod.util.CardInfo;

import static vampiremod.vampiremod.makeID;

public class Cook extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Cook", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new CookPower(p, magicNumber), magicNumber));
    }
