...
import static vampiremod.util.TextureLoader.getCardTextureString;
        ...
        if (!upgraded) {
            ...
            if (this.upgradesDescription) {
                if (cardStrings.UPGRADE_DESCRIPTION == null) {
                    vampiremod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                } else {
