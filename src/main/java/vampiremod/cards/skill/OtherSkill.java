...
import vampiremod.actions.OtherSkillAction;
import vampiremod.cards.BaseCard;
import vampiremod.util.CardInfo;

import static vampiremod.vampiremod.makeID;

public class OtherSkill extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Other_skill", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new OtherSkillAction(this.upgraded));
    }
    @Override
    public AbstractCard makeCopy() {
        return new OtherSkill();
    }
