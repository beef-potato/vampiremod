...
public class Limitbreak_B extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Limitbreak_B", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
