...
public class BloodArmor extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "BloodArmor", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
