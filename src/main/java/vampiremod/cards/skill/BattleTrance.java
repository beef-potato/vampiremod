...
import vampiremod.actions.BattleTranceFollowUpAction;
import vampiremod.cards.BaseCard;
import vampiremod.util.CardInfo;

import static vampiremod.vampiremod.makeID;

public class BattleTrance extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "BattleTrance", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DrawCardAction(magicNumber, new BattleTranceFollowUpAction()));
    }
    @Override
