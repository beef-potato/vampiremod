...
public class Trinity extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Trinity", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    private static final int DRAW_OR_E = 3;
