...
public class BurntCoin extends BaseCard{
    private final static CardInfo cardInfo = new CardInfo(
            "BurntCoin", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DrawCardAction(CARD));
    }
