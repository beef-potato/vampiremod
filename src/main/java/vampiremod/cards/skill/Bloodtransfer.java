...
public class Bloodtransfer extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Bloodtransfer", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    private static final int HP_LOST = 8;
