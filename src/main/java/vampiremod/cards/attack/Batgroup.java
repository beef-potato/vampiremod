...
public class Batgroup extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Batgroup", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for(int i = 0; i < this.magicNumber; ++i) {
            this.addToBot(new DamageAllEnemiesAction(p, damage, this.damageTypeForTurn,
