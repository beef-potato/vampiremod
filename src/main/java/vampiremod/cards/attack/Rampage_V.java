...
public class Rampage_V extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Rampage_V", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new DamageAction(p, new DamageInfo(p, HP_LOST, DamageInfo.DamageType.HP_LOSS),
