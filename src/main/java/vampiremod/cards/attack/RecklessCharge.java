...
public class RecklessCharge extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "RecklessCharge", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new MakeTempCardInDrawPileAction(new Clumsy(), 1, true,true));
        }
