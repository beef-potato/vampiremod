...
public class Armament extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Armament", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with
    ...
    public Armament() {
        ...
        setBlock(BLOCK); //Sets the card's Block and how much it increases when upgraded.
    }
